...
### 初学者路径
1. README（本文档）→ 01 架构设计 → 02 上下文工程 → 08 最佳实践

### 开发者路径
1. 01 架构设计 → 03 Subagent → 04 异步 Agent → 05 高级特性

### 架构师路径
1. 01 架构设计 → 02 上下文工程 → 07 MCP 集成 → 08 最佳实践

### 企业用户路径
1. 01 架构设计 → 06 Hook 系统 → 08 最佳实践 → 07 MCP 集成
